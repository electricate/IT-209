# Program File Name: IT209_aiden_vosoghi_A5.py
# Assignment #5 (A5): Department/Student/Faculty Classes
# Author: Aiden Vosoghi

# The purpose of this assignment is to demonstrate working
# knowledge of using inheritance along with subclasses.

# For this assignment, we create a 'Person' class which is
# used as a parent class from which the 'Student' and 'Faculty'
...
# FACULTY objects within that department.
    ...
    def printdeptPeople (self, group = 'a'):
        if group == 's':
            print('List of all STUDENTS in {} department:\n'.format(self.d_name))
        elif group == 'f':
            print('List of all FACULTY in {} department:\n'.format(self.d_name))
        else:
            print('List of all PEOPLE in {} department:\n'.format(self.d_name))
